...
<body>
        ...
        <div class="main_header_content">
            ...
            <nav class="main_header_content_menu">
                <ul>
                    ...
                    <li class="fonte-li"><a href="../view/minhaempresaP.php">Acompanhar empresa</a></li>
                    <li class="fonte-li"><a href="../view/cadastrarproduto.php">Cadastrar produtos</a></li>
                    <?php
                        if(!isset($_SESSION['idUsu'])) {
                    ...
                    ?>
                   <div class="btn-contato"><a href="../view/pagprodutos.php"><button>Ver meus produtos</button></a></div>
                   <li class="fonte-lii">
    ...
    <div class="menu-options" id="menuOptions">
        ...
        <a href="../view/painelpremium.php" class="menu-item">Painel Premium</a>
    </div>
</div>
                    ...
                    <article class="main_cta_content">
                        <div class="main_cta_content_spacer">
                            <header>
                                ...
                                <h1><b class="ponto">OLÁ <?php echo $nome?></b> <img src="../img/Design_sem_nome__16_-removebg-preview.png" alt="premium" width="100px">, <br> SE PROCURA SERVIÇOS DE QUALIDADE, NÓS TEMOS AS MELHORES MICROEMPRESAS <br> <b class="ponto">ESPERANDO POR VOCÊ.</b></h1>
                            </header>
                            <!-- <div class="headline1"> -->
