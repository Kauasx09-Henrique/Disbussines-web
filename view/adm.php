...
$empresaDAO = new EmpresaDAO();
  ...
  $empresas = $empresaDAO->listarEmpresasDoUsuario($id);
...
<head>
    ...
    <link rel="icon" href="../icon/person.png" type="image/x-icon">
        ...
        <div class="main_header_content">
            ...
            <nav class="main_header_content_menu">
                <ul>
                    ...
                    <li class="fonte-li"><a href="cadastroUsuario.php" >Login</a></li>
                   <div class="btn-contato"><a href="../view/telaADm.php"><button>PAINEL ADM</button></a></div>
                   <li class="fonte-lii"><a href="../index.php" ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                    ...
                    <article class="main_cta_content">
                        <div class="main_cta_content_spacer">
                            <header>
                                ...
                                <h1><b class="ponto"> OLÁ ADM, </b><br> SE PROCURA SERVIÇOS DE QUALIDADE, NÓS TEMOS AS MELHORES MICROEMPRESAS <br> <b class="ponto">ESPERANDO POR VOCÊ.</b></h1>
                            </header>
                            <!-- <div class="headline1"> -->
    ...
    <?php foreach ($empresasAprovadas as $empresa): ?>
        <div class="modern-tour-item">
            ...
            <div class="tour-info">
                ...
                <!-- Avaliações fictícias, você pode alterar conforme desejar -->
                <p class="rating">
                    <span class="stars">★★★☆☆</span> 160 avaliações
                </p>
                
                <!-- Botão para redirecionar para mais informações -->
